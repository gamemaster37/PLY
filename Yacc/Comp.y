%token OPAL OPASS COMP STR INT DEC LONG IMG VAR SALTO MULT MENOS MAS FOR IN DEC
%start START
...
MULTISTART:'PASS'| DECLARACION | IMPORT | DEFF | PRINT | WHILEE | FO | DERAGEX | IFF |SALTO {column++;};
...
PLUSTART: MULTISTART | 'BREAK' | 'CONTINUE' | PLUSTART;     
